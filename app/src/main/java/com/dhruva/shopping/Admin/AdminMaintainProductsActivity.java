...
public class AdminMaintainProductsActivity extends AppCompatActivity {
    ...
    private void applyChanges() {
        ...
        if(pName.equals(""))
        {
            Toast.makeText(this,"Update Product Name",Toast.LENGTH_SHORT).show();
        }else if(pPrice.equals(""))
        {
            Toast.makeText(this,"Update Product Price",Toast.LENGTH_SHORT).show();
        }else if(pDescription.equals(""))
        {
            Toast.makeText(this,"Update Product Description",Toast.LENGTH_SHORT).show();
        }else {
               ...
               if(task.isSuccessful())
                    {
                        ...
                        startActivity(intent);
                        finish();
                        Toast.makeText(AdminMaintainProductsActivity.this, "Product Changes Applied Successfully",Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
